...
--
-- Host: 127.0.0.1
-- Tempo de geração: 06/06/2025 às 05:48
...
--
ALTER TABLE `armaduras`
  MODIFY `id_armadura` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `armas`
--
ALTER TABLE `armas`
  MODIFY `id_arma` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
